...
def run_agents(topic):
    ...
    def handle_pro(state):
        ...
        if summary == 'Nothing':
            ...
            prompt = prefix_start.format(charachter_desc, classes[0], classes[1], debate_topic, 'Nothing', classes[0], "Nothing", data)
            ...
            data = load_from_vector(classes[0], debate_topic, current_response)
            prompt = prefix_start.format(charachter_desc, classes[0], classes[1], debate_topic, summary, classes[0], current_response,
                                         data)
            argument = classes[0] + ":" + llm(prompt)
            add_message("SJB", argument)
            # print(classes[0] + ":" + argument)
    ...
    def handle_opp(state):
        ...
        prompt = prefix_start.format(charachter_desc, classes[1], classes[0], debate_topic, summary, classes[1], current_response, data)
